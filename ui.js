...
function thead(isShoppingCart) {
	...
	$td_nbsp = td("", "");
	if (!isShoppingCart) {
		$td_nbsp = td("Back to Top", "th_gotop");
...
function row(piece, isShoppingCart) {
	...
	$lineTop.append(td(render(csv[3]), getStyle(csv[3]), "Simple"));
	$lineTop.append(td(render(csv[4]), getStyle(csv[4]), "Gorgeous"));
	$lineTop.append(td(render(csv[5]), getStyle(csv[5]), "Cute"));
	$lineTop.append(td(render(csv[6]), getStyle(csv[6]), "Mature"));
	$lineTop.append(td(render(csv[7]), getStyle(csv[7]), "Lively"));
	$lineTop.append(td(render(csv[8]), getStyle(csv[8]), "Elegant"));
	$lineTop.append(td(render(csv[9]), getStyle(csv[9]), "Pure"));
	$lineTop.append(td(render(csv[10]), getStyle(csv[10]), "Sexy"));
	$lineTop.append(td(render(csv[11]), getStyle(csv[11]), "Cool"));
	$lineTop.append(td(render(csv[12]), getStyle(csv[12]), "Warm"));
